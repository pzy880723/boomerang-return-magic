...
import { SINGLE_STEPS, buildMultiSteps, type NarrativeStep } from '@/lib/recognitionNarrative';
...
export const CameraStage = forwardRef<CameraStageHandle, CameraStageProps>(function CameraStage(
  ...
  const [narrativeSteps, setNarrativeSteps] = useState<NarrativeStep[]>(SINGLE_STEPS);
